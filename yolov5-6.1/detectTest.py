            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:
                        ...
                        # 在这里添加调整边界框大小的代码
                        # 例如，可以将宽度和高度乘以一个比例因子
                        scale_factor = 1.5 # 你可以根据需要调整这个比例因子
                        width = x_max - x_min
                        height = y_max - y_min
                        ...
                        if save_img:
                            cv2.imwrite(str(save_dir / f'{p.stem}.jpg'), im0)
                        ...
                        if view_img:
                            ...
                            cv2.waitKey(1)  # 1 millisecond delay to refresh display
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/NGYF1.MP4', help='file/dir/URL/glob, 0 for webcam')
